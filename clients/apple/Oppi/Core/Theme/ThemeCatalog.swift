...
enum ThemePalettes {
    ...
    static let light = ThemePalette(
        ...
        toolOutput: c(0x4D5065),
        // Markdown
        mdHeading: c(0x174EB8),
        mdLink: c(0x1A6575),
        mdLinkUrl: c(0x52566C),
        mdCode: c(0x0E6A72),
        mdCodeBlock: c(0x236212),
        mdCodeBlockBorder: c(0x52566C),
        mdQuote: c(0x52566C),
        ...
        syntaxPunctuation: c(0x4D5065),
        // Thinking
        thinkingOff: c(0xACB0BE),
        thinkingMinimal: c(0x52566C),
